...
- `manifest` (String, Sensitive) Computed rendered manifest (multi-document YAML). Marked sensitive because set_sensitive values may be rendered into the template output.
