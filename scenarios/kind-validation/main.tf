...
locals {
  cluster = {
    ...
    cluster_ca_certificate = kind_cluster.kind_validation.cluster_ca_certificate
    client_certificate     = kind_cluster.kind_validation.client_certificate
    client_key             = kind_cluster.kind_validation.client_key
  }
}
