...
func TestAccHelmReleaseResource_Basic(t *testing.T) {
	t.Parallel()
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("k8sconnect_helm_release.test", "chart", "../../../../test/testdata/charts/simple-test"),
					...
					testhelpers.CheckNamespaceExists(k8sClient, namespace),
...
func testAccHelmReleaseConfigBasic(releaseName, namespace string) string {
