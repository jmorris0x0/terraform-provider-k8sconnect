// internal/k8sconnect/resource/object/formatting_test.go
package object_test
...
func TestAccObjectResource_NoUpdateOnFormattingChanges(t *testing.T) {
	t.Parallel()
...
resource "k8sconnect_object" "formatting_namespace" {
  yaml_body = <<YAML
apiVersion: v1
kind: Namespace
metadata:
...
YAML
  ...
  depends_on = [k8sconnect_object.formatting_namespace]
}
