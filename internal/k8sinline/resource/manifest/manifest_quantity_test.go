// internal/k8sinline/resource/manifest/manifest_quantity_test.go
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet("k8sinline_manifest.test_quota", "id"),
					resource.TestCheckResourceAttrSet("k8sinline_manifest.test_quota", "managed_state_projection"),
				),
			},
			{
...
resource "k8sinline_manifest" "test_quota" {
  yaml_body = <<YAML
apiVersion: v1
kind: ResourceQuota
metadata:
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("k8sinline_manifest.test_pvc_quantity", "id"),
...
resource "k8sinline_manifest" "test_pvc_quantity" {
  yaml_body = <<YAML
apiVersion: v1
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("k8sinline_manifest.test_deployment", "id"),
				),
			},
			{
...
resource "k8sinline_manifest" "test_deployment" {
  yaml_body = <<YAML
apiVersion: apps/v1
kind: Deployment
metadata:
