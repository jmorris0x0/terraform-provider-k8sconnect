// internal/k8sinline/datasource/yaml_split/yaml_split_acc_test.go
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet("data.k8sinline_yaml_split.test", "id"),

					// map should contain exactly two entries
					resource.TestCheckResourceAttr("data.k8sinline_yaml_split.test", "manifests.%", "2"),

					// verify each manifest’s content
					resource.TestCheckResourceAttr(
						"data.k8sinline_yaml_split.test",
